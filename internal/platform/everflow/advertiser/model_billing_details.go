...
// BillingDetails Billing frequency details (required for specific frequencies)
type BillingDetails struct {
	// Day of the week (for weekly frequency)
	DayOfWeek *int32 `json:"day_of_week,omitempty"`
	// First day of the month (for bimonthly frequency)
	DayOfMonthOne *int32 `json:"day_of_month_one,omitempty"`
	// Second day of the month (for bimonthly frequency)
	DayOfMonthTwo *int32 `json:"day_of_month_two,omitempty"`
	// Day of the month (for monthly, two_months, quarterly)
	DayOfMonth *int32 `json:"day_of_month,omitempty"`
	// Starting month for cycle (for two_months, quarterly)
