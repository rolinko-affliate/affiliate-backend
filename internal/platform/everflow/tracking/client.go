...
// APIClient manages communication with the Everflow Network API - Tracking API v1.0.0
...
func (c *APIClient) callAPI(request *http.Request) (*http.Response, error) {
	if c.cfg.Debug {
		_, err := httputil.DumpRequestOut(request, true)
		if err != nil {
			return nil, err
		}
...
// MappedNullable interface for nullable types
