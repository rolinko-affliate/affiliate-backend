...
// checks if the UpdateOfferRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateOfferRequest{}

// UpdateOfferRequest Same as CreateOfferRequest but all fields must be provided
...
type _UpdateOfferRequest UpdateOfferRequest
...
func (o UpdateOfferRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateOfferRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateOfferRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateOfferRequest := _UpdateOfferRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateOfferRequest)

	if err != nil {
		return err
	}

	*o = UpdateOfferRequest(varUpdateOfferRequest)

	return err
}

type NullableUpdateOfferRequest struct {
	value *UpdateOfferRequest
	isSet bool
}

func (v NullableUpdateOfferRequest) Get() *UpdateOfferRequest {
	return v.value
}

func (v *NullableUpdateOfferRequest) Set(val *UpdateOfferRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateOfferRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateOfferRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateOfferRequest(val *UpdateOfferRequest) *NullableUpdateOfferRequest {
	return &NullableUpdateOfferRequest{value: val, isSet: true}
}

func (v NullableUpdateOfferRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateOfferRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
